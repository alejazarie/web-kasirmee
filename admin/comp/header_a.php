...
<!--  -->
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-color:#28a745;">
    <!-- Brand Logo -->
    <a href="" class="brand-link">
    <img src="<?= url()?>img/logo_kasir_kita.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
     style="opacity: .8; pointer-events: none;">

           <span class="brand-text font-weight-light" style="pointer-events: none;">Web Kasirmee</span>
